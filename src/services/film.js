...
const res =
  "Fallo su conexion a internet comuniquese con el equipo de INDQ, id:";
...
export const get_films_select = async () => {
  try {
    const response = await axios.get(`${URL}films/select/`);
    return response.data;
  } catch (error) {
...
export const get_films_paginated = async (page) => {
  try {
